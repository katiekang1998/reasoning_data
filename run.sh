...
do
    ...
    CUDA_VISIBLE_DEVICES=1,2,3,4 torchrun --nproc_per_node=4 --master_port=1235 math_aug_train.py --num_train_points ${NUM_TRAIN_POINTS} --easy_ratio ${EASY_RATIO} --medium_ratio ${MEDIUM_RATIO} --hard_ratio ${HARD_RATIO}
    ...
    CUDA_VISIBLE_DEVICES=1,2 python math_eval.py --eval_type train_aug_subsample --ckpt_dir ${CKPT_NAME} &
    P1=$!
    CUDA_VISIBLE_DEVICES=3,4 python math_eval.py --eval_type test --ckpt_dir ${CKPT_NAME} &
    P2=$!
    wait $P1 $P2
